...
Perlin.permutation = [151,160,137,91,90,15,131,13,201,95,96,53,194,233,7,225,140,36,103,30,69,142,
...
function drawNebula() {
  ...
  for (let y = 0; y < height; y++) {
    for (let x = 0; x < width; x++) {
      ...
      data[index]     = color[0]; // Rouge
      data[index + 1] = color[1]; // Vert
      data[index + 2] = color[2]; // Bleu
